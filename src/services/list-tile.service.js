(function(){
    ...
    function taskListService($q, $log, $sessionStorage, $localStorage) {
        ...
        self.taskIconList = [{title: "Fin.", doThis: self.finishTask, class: "icon_finish"},{title: "Edit", doThis: self.editTask, class: "icon_edit"},{title: "", doThis: self.flagTask, class: "icon_flag"},{title: "", doThis: self.deleteTask, class: "icon_delete"}];
