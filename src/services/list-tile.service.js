(function(){
    ...
    function taskListService($q, $log, $sessionStorage, $localStorage) {
        ...
        self.buttonlist = [{title: "Lists",route: "list-tile", doThis: self.doNothing,class: "lists_button"},{title: "New List", route: "list-tile", doThis: self.addList, class: "lists_button"}];
